...
class WizardBasicInfo extends Equatable {
  ...
  List<Object?> get props =>
      [cabinName, ipAddress, location, port, timeoutSeconds, sslEnabled];
}
...
final class MobileDrawerConfig extends DrawerConfig {
  ...
  MobileDrawerConfig copyWith({
    int? drawerCount,
    List<MobileDrawerRow>? rows,
  }) {
    return MobileDrawerConfig(
