...
class AppSubNav extends StatelessWidget {
  const AppSubNav({super.key, required this.items, required this.isLoggedIn, required this.shiftLabel, this.onItemTap});
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          ...items.map((item) {
            final locked = item.requiresAuth && !isLoggedIn;
            return _NavItem(item: item, isLocked: locked, onTap: locked ? null : () => onItemTap?.call(item.id));
          }),
          const Spacer(),
          // Vardiya bilgisi
          Padding(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(text: context.l10n.navShift),
                  TextSpan(
                    text: shiftLabel,
...
class _NavItem extends StatelessWidget {
  const _NavItem({required this.item, required this.isLocked, this.onTap});
    ...
    return GestureDetector(
      ...
      child: AnimatedOpacity(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: Border(bottom: BorderSide(color: item.isActive ? MedColors.blue : Colors.transparent, width: 2)),
          ),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(item.icon, size: 12, color: item.isActive ? MedColors.blue : MedColors.text3),
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color: item.isActive ? MedColors.blue : MedColors.text3,
                ),
              ),
            ],
          ),
          ...
          Expanded(
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(
                    text: context.l10n.navLockedBannerPre,
                    style: TextStyle(color: MedColors.text2),
                  ),
                  TextSpan(
                    text: context.l10n.navLockedBannerHighlight,
                    style: const TextStyle(color: MedColors.amber, fontWeight: FontWeight.w600),
                  ),
                  TextSpan(
                    text: context.l10n.navLockedBannerPost,
                    style: TextStyle(color: MedColors.text2),
                  ),
                ],
              ),
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                context.l10n.navSessionExpiringTitle,
              ...
              RichText(
                text: TextSpan(
                  style: MedTextStyles.bodySm(color: MedColors.text2),
                  children: [
                    TextSpan(text: context.l10n.navSessionTimeoutPre),
                    TextSpan(
                    ...
                    TextSpan(text: context.l10n.navSessionTimeoutPost),
                  ],
                ),
              ),
            ],
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(context.l10n.navLoginSubtitle(widget.cabinCode), style: MedTextStyles.monoXs()),
                    ],
                  ),
                ],
              ),
