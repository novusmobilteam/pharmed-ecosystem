    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            context.l10n.topBarLocation(location, cabinCode),
    ...
    return Row(
      children: [
        _badge(
          ...
          label: isOnline ? context.l10n.topBarOnline : context.l10n.topBarOffline,
        ...
        if (alertCount > 0) ...[
          ...
          _badge(
            ...
            label: context.l10n.topBarAlertCount(alertCount),
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(context.l10n.topBarLogout, style: MedTextStyles.bodySm(color: MedColors.text3)),
              ],
            ),
          ),
        ),
