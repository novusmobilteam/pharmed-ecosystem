...
abstract final class DI {
  ...
  static SetupWizardDataSource setupWizardDataSource({
  ...
  static SetupWizardRepositoryImpl setupWizardRepository({
    bool forceError = false,
  }) {
    return SetupWizardRepositoryImpl(
      dataSource: setupWizardDataSource(forceError: forceError),
    );
  }
}
