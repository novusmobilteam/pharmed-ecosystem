...
class _MedSelectFieldState<T> extends State<MedSelectField<T>>
  ...
  MedSelectOption<T>? get _selected =>
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: _open ? MedColors.blue : MedColors.border,
                  width: 1.5,
                ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(
              color: Color(0x1F1E3259), blurRadius: 32, offset: Offset(0, 12)),
          BoxShadow(
              color: Color(0x0F1E3259), blurRadius: 8, offset: Offset(0, 4)),
        ],
      ),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(10),
        ...
        child: Row(
          children: [
            ...
            if (widget.isSelected)
              const Icon(Icons.check_rounded, size: 16, color: MedColors.blue),
          ],
        ),
      ),
    );
