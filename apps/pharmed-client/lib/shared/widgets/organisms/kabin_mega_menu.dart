      ...
      child: IntrinsicHeight(
        child: Row(
          ...
          children: [
            _Sidebar(
              active: _active,
              onSelect: (cat) => setState(() => _active = cat),
            ),
            Expanded(
              child: _ContentPanel(
                category: _active,
                onCardTap: widget.onCardTap,
                onQuickTap: widget.onQuickTap,
              ),
            ),
          ],
        ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: switch (category) {
        _KabinCategory.dizayn =>
          _DizaynPanel(onCardTap: onCardTap, onQuickTap: onQuickTap),
        _KabinCategory.ariza =>
          _ArizaPanel(onCardTap: onCardTap, onQuickTap: onQuickTap),
        _KabinCategory.erisim =>
          _ErisimPanel(onCardTap: onCardTap, onQuickTap: onQuickTap),
        _KabinCategory.baglanti =>
          _BaglantiPanel(onCardTap: onCardTap, onQuickTap: onQuickTap),
      },
    );
  }
}
            ...
            children: [
              AnimatedContainer(
                ...
                child: Icon(
                  widget.data.icon,
                  size: 18,
                  color: _hovered ? Colors.white : widget.data.iconColor,
                ),
              ),
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: MedTextStyles.bodySm(
                        color: _hovered ? MedColors.text2 : MedColors.text3,
                      ),
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
                    ),
...
class _QuickBtn extends StatelessWidget {
  const _QuickBtn({
    required this.label,
    required this.icon,
    this.variant = _QuickBtnVariant.normal,
    this.onTap,
  });
  ...
  Widget build(BuildContext context) {
    final (bg, borderColor, textColor) = switch (variant) {
      _QuickBtnVariant.normal => (
          MedColors.surface,
          MedColors.border,
          MedColors.text2,
        ),
      _QuickBtnVariant.primary => (
          MedColors.blue,
          MedColors.blue,
          Colors.white,
        ),
      _QuickBtnVariant.danger => (
          MedColors.red,
          MedColors.red,
          Colors.white,
        ),
    ...
    return _Panel(
      ...
      quickActions: [
        _QuickBtn(
          ...
          onTap: () => onQuickTap?.call('dizayn_onizle'),
        ),
        const SizedBox(width: 8),
        _QuickBtn(
          label: 'Sıfırla',
          icon: Icons.refresh_rounded,
          onTap: () => onQuickTap?.call('dizayn_sifirla'),
        ),
        const Spacer(),
        _QuickBtn(
          label: 'Kaydet',
