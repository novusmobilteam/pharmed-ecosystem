...
class MedKeyboardController extends ChangeNotifier {
  ...
  void pressChar(String char) {
    ...
    if (char == 'backspace') {
      ...
      final newText =
          text.substring(0, sel.start) + c + text.substring(sel.end);
      ctrl.value = TextEditingValue(
        text: newText,
...
class MedKeyboardScope extends InheritedNotifier<MedKeyboardController> {
  const MedKeyboardScope({
    super.key,
    required MedKeyboardController controller,
    required super.child,
  }) : super(notifier: controller);

  static MedKeyboardController? maybeOf(BuildContext context) {
    return context
        .dependOnInheritedWidgetOfExactType<MedKeyboardScope>()
        ?.notifier;
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: const Border(
          top: BorderSide(color: MedColors.border, width: 2),
        ),
        boxShadow: const [
          BoxShadow(
            color: Color(0x1F1E3259),
            blurRadius: 32,
            offset: Offset(0, -8),
          ),
        ],
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isActive ? MedColors.blue : MedColors.border,
          ),
          borderRadius: BorderRadius.circular(6),
        ),
        child: Text(
      ...
      children: [
        ...
        _KbRow(
          children: [
            ...
            _SpecialKey(
              label: '⌫',
              flex: 2,
              onTap: () => controller.pressChar('backspace'),
            ),
          ],
        ),
        ...
        _KbRow(
          children: [
            ...
            _ActionKey(
              label: '↵ Tamam',
              flex: 2,
              onTap: () => controller.pressChar('enter'),
            ),
          ],
        ),
        const SizedBox(height: 5),
        ...
        _KbRow(
          children: [
            ...
            _SpecialKey(
                label: '0', onTap: () => controller.pressChar('0')),
            _SpecialKey(
                label: '1', onTap: () => controller.pressChar('1')),
            _SpecialKey(
                label: '2', onTap: () => controller.pressChar('2')),
            _SpecialKey(
                label: '3', onTap: () => controller.pressChar('3')),
          ],
        ),
      ],
    );
                  ...
                  if (row < 3) ...[
                    for (var col = 0; col < 3; col++) ...[
                      _NumKey(
                        ...
                        onTap: () =>
                            controller.pressChar(_keys[row * 3 + col]),
                      ),
...
class _KbRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: children
          .expand((c) => [c, const SizedBox(width: 5)])
          .toList()
        ..removeLast(),
    );
  }
...
class _KeyState extends State<_Key> {
  ...
  @override
  Widget build(BuildContext context) {
    final label = widget.controller.shift
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _pressed ? MedColors.blue : MedColors.border,
              width: 1.5,
            ),
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: _pressed
                    ? Colors.transparent
                    : const Color(0xFF1560C0),
                blurRadius: 0,
                offset: const Offset(0, 3),
              ),
              BoxShadow(
                color: const Color(0x4D1A6FD8),
                blurRadius: 8,
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color:
                    _pressed ? Colors.transparent : const Color(0xFF1560C0),
                blurRadius: 0,
                offset: const Offset(0, 3),
              ),
            ],
