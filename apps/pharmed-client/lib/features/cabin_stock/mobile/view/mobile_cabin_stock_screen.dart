...
class MobileCabinStockScreen extends ConsumerStatefulWidget {
  const MobileCabinStockScreen({super.key, this.cabinRouteContext});

  final CabinRouteContext? cabinRouteContext;

  @override
  ConsumerState<MobileCabinStockScreen> createState() => MobileCabinStockScreenState();
}

class MobileCabinStockScreenState extends ConsumerState<MobileCabinStockScreen> {
  @override
  void initState() {
    super.initState();
...
class _StockRightPanel extends StatelessWidget {
  ...
  final MobileCabinStockState state;
