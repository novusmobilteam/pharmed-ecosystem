...
import 'mobile_cabin_stock_state.dart';

final cabinStockNotifierProvider = NotifierProvider<MobileCabinStockNotifier, MobileCabinStockState>(
  MobileCabinStockNotifier.new,
);

class MobileCabinStockNotifier extends Notifier<MobileCabinStockState> {
  ...
  @override
  MobileCabinStockState build() => const CabinStockUninitialized();
