...
class RefillListExecutionView extends ConsumerWidget {
  const RefillListExecutionView({super.key, required this.cabinDataByCabinId});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final executing = switch (state) {
      RefillListExecuting e => e,
      RefillListError(previousState: RefillListExecuting e) => e,
      _ => null,
    };
    ...
    return CabinOperationExecutionLayout(
      ...
      locationItems: executing.toLocationItems(cabinDataByCabinId),
...
class _FillForm extends ConsumerWidget {
  ...
  final RefillListExecuting state;
  final CabinOperationDrawerJob job;
  final RefillListNotifier notifier;
