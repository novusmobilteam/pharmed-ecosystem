...
// class PharmacyWarehouseFormView extends StatelessWidget {
//   const PharmacyWarehouseFormView({super.key, required this.type});
...
//     return Consumer<PharmacyWarehouseFormNotifier>(
...
//       label: 'Miktar',
//       onChanged: (value) {
//         context.read<PharmacyWarehouseFormNotifier>().updateQuantity(int.tryParse(value ?? ""));
//       },
//     );
//   }
// }
