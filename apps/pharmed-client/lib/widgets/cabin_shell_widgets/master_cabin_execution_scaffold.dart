...
class MasterCabinExecutionScaffold extends ConsumerStatefulWidget {
  const MasterCabinExecutionScaffold({
    super.key,
  ...
  @override
  ConsumerState<MasterCabinExecutionScaffold> createState() => _MasterCabinExecutionScaffoldState();
}

class _MasterCabinExecutionScaffoldState extends ConsumerState<MasterCabinExecutionScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Expanded(
          child: CabinOperationPanelLayout(
            left: CabinLocationGuide(items: widget.locationItems, activeIndex: widget.activeIndex),
