...
final cabinSensorLoggerProvider = Provider<CabinSensorLogger>(
  (ref) => CabinSensorLogger(ref.read(saveSensorValuesUseCaseProvider), ref.read(appSettingsCacheProvider)),
);
