...
class UsecaseProviders {
  static List<SingleChildWidget> providers({bool isDev = false}) {
    return [
      /// Cabin Operations
      Provider(create: (context) => StartMasterDrawerSessionUseCase(context.read(), context.read())),
      Provider(create: (context) => OpenCubicLidUseCase(context.read(), context.read())),
      Provider(create: (context) => MonitorDrawerClosureUseCase(context.read(), context.read())),
      Provider(create: (context) => RefillMasterCabinUseCase(context.read())),
      Provider(create: (context) => CompleteMasterUnloadUseCase(context.read())),
      Provider(create: (context) => CompleteMasterCensusUseCase(context.read())),
      Provider(create: (context) => StreamCabinSensorsUseCase(context.read(), context.read())),
      Provider(
        create: (context) => GetIntakeItemsUseCase(
          intakeRepository: context.read(),
          assignmentRepository: context.read(),
          medicineRepository: context.read(),
        ),
      ),
      Provider(create: (context) => CheckIntakeUseCase(context.read())),
      Provider(create: (context) => CheckEquivalentIntakeUseCase(context.read())),
      Provider(create: (context) => GetEquivalentMedicinesUseCase(context.read(), context.read())),
      Provider(create: (context) => GetOtherStationMedicinesUseCase(context.read())),
      Provider(create: (context) => RedirectIntakeUseCase(context.read())),
      ...
      Provider(create: (context) => WitnessUserLoginUseCase(context.read())),
      ...
      /// Menu
      Provider(create: (context) => GetFilteredMenusUseCase(context.read(), isManager: false)),
      ...
      Provider(create: (context) => GetAllRoomsUseCase(context.read())),
      Provider(create: (context) => GetAllBedsUseCase(context.read())),
      Provider(create: (context) => GetAllServicesUseCase(context.read())),
      ...
      Provider(create: (context) => GetCabinAssignmentsUseCase(context.read())),
