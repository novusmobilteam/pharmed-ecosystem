...
class PrescriptionProviders {
  static List<SingleChildWidget> providers({bool isDev = false}) {
    return [
      ...
      Provider<CreatePrescriptionUseCase>(
        create: (context) => CreatePrescriptionUseCase(prescriptionRepository: context.read()),
      ),
      ...
      Provider<AssignRfidTagUseCase>(create: (context) => AssignRfidTagUseCase(context.read(), context.read())),
      Provider<DeleteRfidTagUseCase>(create: (context) => DeleteRfidTagUseCase(context.read())),
      Provider<CheckAndApprovePrescriptionUseCase>(
        create: (context) => CheckAndApprovePrescriptionUseCase(context.read()),
      ),
    ];
  }
}
