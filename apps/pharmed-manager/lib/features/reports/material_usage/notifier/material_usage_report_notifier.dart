...
class MaterialUsageReportNotifier extends ChangeNotifier with ApiRequestMixin, PaginationMixin<StockTransaction> {
  final GetStationsUseCase _getStationsUseCase;
  final GetMaterialUsagesUseCase _getMaterialUsagesUseCase;

  MaterialUsageReportNotifier({
    required GetStationsUseCase getStationsUseCase,
    required GetMaterialUsagesUseCase getMaterialUsagesUseCase,
  }) : _getStationsUseCase = getStationsUseCase,
       _getMaterialUsagesUseCase = getMaterialUsagesUseCase;
  ...
  Future<void> fetch() async {
    await fetchPagedData(
      op: fetchReportsOp,
      fetchMethod: (skip, take) => _getMaterialUsagesUseCase.call(
