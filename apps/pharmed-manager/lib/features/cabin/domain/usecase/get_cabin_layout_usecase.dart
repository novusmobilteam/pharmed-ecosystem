...
import '../../../cabin_fault/domain/entity/cabin_fault.dart';
import '../../../cabin_fault/domain/repository/i_cabin_fault_repository.dart';
...
class GetCabinLayoutUseCase implements UseCase<List<DrawerGroup>, int> {
