...
class RoleDrugAuthNotifier extends ChangeNotifier with ApiRequestMixin, SearchMixin<RoleDrugAuthentication> {
  final GetRoleDrugAuthenticationUseCase _getAuthUseCase;
  final SaveRoleDrugAuthenticationUseCase _saveAuthUseCase;
  final Role _role;

  RoleDrugAuthNotifier({
    required GetRoleDrugAuthenticationUseCase getAuthUseCase,
    required SaveRoleDrugAuthenticationUseCase saveAuthUseCase,
    required Role role,
  ...
  List<RoleDrugAuthentication> get filteredAuths {
