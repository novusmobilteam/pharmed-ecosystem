...
class KitContentListDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => KitContentNotifier(
        getKitContentUseCase: context.read(),
        deleteKitContentUseCase: context.read(),
      ),
...
Future<void> _showFormDialog(BuildContext context, KitContentNotifier notifier) async {
  final result = await showKitContentFormDialog(
    context,
    kitId: notifier.kitId,
  );
