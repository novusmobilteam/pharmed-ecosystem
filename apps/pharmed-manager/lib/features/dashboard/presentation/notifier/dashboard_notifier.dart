...
import 'package:pharmed_manager/core/providers/providers.dart';
...
class DashboardNotifier extends Notifier<DashboardUiState> {
  ...
  Future<void> _fetchMenus() async {
    ...
    final menuResult = await ref.read(getFilteredMenusUseCaseProvider).call(userId: user?.id);
  ...
  Future<void> _load({bool forceRefresh = false}) async {
    ...
    _resolveState(criticalResult: criticalResult, expiringResult: expiringResult, treatmentsResult: treatmentsResult);
  }
  ...
  void _resolveState({
    ...
    if (criticalStocks == null && expiringMaterials == null && upcomingTreatments == null) {
