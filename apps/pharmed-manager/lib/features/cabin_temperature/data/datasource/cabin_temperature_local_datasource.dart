...
class CabinTemperatureLocalDataSource implements CabinTemperatureDataSource {
  ...
  CabinTemperatureLocalDataSource({required String cabinTemperaturePath, required String cabinTemperatureDetailPath})
    : _cabinTemperatureStore = _CabinTemperatureStore(filePath: cabinTemperaturePath),
      _cabinTemperatureDetailStore = _CabinTemperatureDetailStore(filePath: cabinTemperatureDetailPath);
  ...
  @override
  Future<Result<ApiResponse<List<CabinTemperatureDTO>>>> getCabinTemperatures({int? skip, int? take, String? search}) {
    return _cabinTemperatureStore.fetchRequest(skip: skip, take: take, searchText: search, searchField: 'name');
  }
