...
class UserTableView extends StatelessWidget {
  ...
  List<TableColumnDef> _buildColumnDefs(UserType type) {
    ...
    return [
      TableColumnDef(
        title: type == UserType.normal ? 'T.C Kimlik No' : 'Kurum Sicil No',
      ),
  ...
  Widget build(BuildContext context) {
    return Consumer<UserTableNotifier>(
        ...
        return UnifiedTableView<User>(
          ...
          actions: [
            TableActionItem(
              ...
              tooltip: 'Düzenle',
              onPressed: (user) => _showUserRegistrationDialog(context, vm, user: user),
            ),
            TableActionItem(
