...
class _TableBody<T extends TableData> extends StatelessWidget {
  ...
  final List<T> data;
  final List<_ColMeta<T>> cols; // ← generic
  final double totalFlex;
  final int? sortColIndex;
  final bool sortAsc;
  final Map<int, Set<String>> colFilters; // key = col.index
                ...
                children: [
                  ...
                  ...List.generate(
                    ...
                    (i) => _HeaderCell<T>(
                      ...
                      sortAsc: sortAsc,
                      hasFilter: colFilters.containsKey(cols[i].index) && colFilters[cols[i].index]!.isNotEmpty,
            ...
            AnimatedContainer(
              ...
              child: Row(
                children: [
                  ...
                  // ── Veri hücreleri
                  // Öncelik: kolon cellBuilder → widget.cellBuilder (legacy) → displayValue/content
                      ...
                      child: Padding(
                        ...
                        child: custom != null
                            ? DefaultTextStyle.merge(
                                style: cellStyle,
                                child: Align(alignment: Alignment.centerLeft, child: custom),
                              )
                            : Text(
                                text,
...
class _ActiveFilterBar<T extends TableData> extends StatelessWidget {
  ...
  String _titleFor(BuildContext context, int colIndex) {
    try {
      return cols.firstWhere((c) => c.index == colIndex).title;
    } catch (_) {
