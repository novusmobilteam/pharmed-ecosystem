...
/// Halka grafik — SKT ve stok sayaçları için.
///
/// ```dart
/// MedRingChart(count: 2, total: 10, color: MedColors.red, label: 'Kritik')
/// ```
class MedRingChart extends StatelessWidget {
  const MedRingChart({
    super.key,
    required this.count,
    required this.total,
  ...
  /// false → halka altındaki açıklama metni gizlenir.
...
typedef RingChart = MedRingChart;
