...
/// )
/// ```
class MedMultiSelectionField<T extends Selectable> extends StatefulWidget {
  const MedMultiSelectionField({
    super.key,
    required this.label,
    this.title,
  ...
  @override
  State<MedMultiSelectionField<T>> createState() => _MedMultiSelectionFieldState<T>();
}

class _MedMultiSelectionFieldState<T extends Selectable> extends State<MedMultiSelectionField<T>> {
  @override
