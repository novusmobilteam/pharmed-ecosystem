...
/// )
/// ```
class MedSelectionField<T extends Selectable> extends StatefulWidget {
  const MedSelectionField({
    super.key,
    required this.label,
    this.title,
  ...
  @override
  State<MedSelectionField<T>> createState() => _MedSelectionFieldState<T>();
}

class _MedSelectionFieldState<T extends Selectable> extends State<MedSelectionField<T>> {
  @override
