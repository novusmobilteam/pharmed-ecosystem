...
/// Semantik metin varyantları — kart başlıkları, section label, mono değerler.
///
/// ```dart
/// MedLabel(text: 'Kritik Stok', variant: MedLabelVariant.cardLabel)
/// ```
class MedLabel extends StatelessWidget {
  const MedLabel({super.key, required this.text, required this.variant, this.color, this.overflow, this.maxLines});
