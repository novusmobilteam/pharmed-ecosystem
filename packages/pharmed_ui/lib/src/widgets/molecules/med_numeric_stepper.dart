        ...
        Container(
          ...
          child: IntrinsicHeight(
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                _StepButton(icon: Icons.remove, enabled: canDec, onTap: canDec ? _decrement : null, isLeft: true),
                ...
                Container(width: 1, color: MedColors.border2),
                _StepButton(icon: Icons.add, enabled: canInc, onTap: canInc ? _increment : null, isLeft: false),
              ],
            ),
          ),
        ),
...
class _StepButton extends StatefulWidget {
  const _StepButton({required this.icon, required this.enabled, required this.isLeft, this.onTap});
  final IconData icon;
  final bool enabled;
  final bool isLeft;
