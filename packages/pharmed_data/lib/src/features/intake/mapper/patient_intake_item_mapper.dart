...
class PatientIntakeItemMapper {
  const PatientIntakeItemMapper();

  PatientMedicineIntakeItem toEntity(PatientMedicineIntakeItemDto dto) {
    return PatientMedicineIntakeItem(
      id: dto.id ?? 0,
  ...
  MedicineAssignment _mapToCabinAssignment(PatientMedicineIntakeItemDto dto) {
  ...
  List<PatientMedicineIntakeItem> toEntityList(List<PatientMedicineIntakeItemDto> dtos) => dtos.map(toEntity).toList();

  PatientMedicineIntakeItemDto toDto(PatientMedicineIntakeItem entity) {
