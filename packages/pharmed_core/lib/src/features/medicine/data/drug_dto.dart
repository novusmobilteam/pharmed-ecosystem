...
class DrugDTO extends MedicineDTO {
  ...
  Drug toEntity() {
    return Drug(
      ...
      dose: dose,
      doseUnit: UnitMapper().toEntityOrNull(doseUnit),
      isMeasureUnit: isMeasureUnit,
      unitMeasure: UnitMapper().toEntityOrNull(unitMeasure),
      doseMeasureUnit: doseMeasureUnit,
      volume: volume,
      volumeUnit: UnitMapper().toEntityOrNull(volumeUnit),
      ...
      materialOrderlessTakingUsers: materialOrderlessTakingUsers != null
          ...
          : [],
      witnessedPurchaseStations: StationMapper().toEntityList(witnessedPurchaseStations ?? []),
      wastageWitnessedPurchaseStations: StationMapper().toEntityList(wastageWitnessedPurchaseStations ?? []),
