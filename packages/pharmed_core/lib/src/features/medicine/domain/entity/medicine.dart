...
sealed class Medicine extends Selectable {
...
extension MedicineDoseConfig on Medicine {
  /// true ise birim 'Adet' (lokalize edilmeli), false ise servis değeri
  ...
  /// Lokalizasyon gerektirmeyen servis taraflı birim adı.
  /// isUnitPiece true ise null döner — view context.l10n.common_unitPiece kullanır.
  String? get operationUnitRaw {
    final self = this;
    if (self is! Drug) return null;
    if (!self.isMeasureUnit) return null;
    return self.unitMeasure?.name;
  }
  ...
  /// Örn: "Adet", "ml", "mg"
  @Deprecated('operationUnitLocalized kullanılacak')
  ...
  String operationUnitLocalized(BuildContext context) {
    final self = this;
