...
class CabinSensorReading {
  ...
  double? get batteryPercent =>
      batteryVolts == null ? null : BatteryLevelConverter.toPercent(batteryVolts!);

  bool get isBatteryCritical =>
      batteryVolts != null && BatteryLevelConverter.isCritical(batteryVolts!);
