...
class Role extends Selectable implements TableData {
  ...
  Role({super.id, this.name, this.isActive = true})
  ...
  Role copyWith({int? id, String? name, bool? isActive}) {
    return Role(id: id ?? this.id, name: name ?? this.name, isActive: isActive ?? this.isActive);
  }
}
